const QUESTIONS = [
    {
        label: "Was ist der wichtigste erste Schritt vor einer Finanzentscheidung?",
        answers: [
            "Ein persönliches finanzielles Ziel definieren",
            "Investieren ohne jegliche Planung",
            "Sich auf Zufall und Glück verlassen",
            "Empfehlungen in sozialen Medien ungeprüft folgen",
        ],
    },
    {
        label: "Welche Art der Geldanlage wird oft als sicherer betrachtet?",
        answers: [
            "Langfristige Investitionen in breit gestreute Fonds",
            "Investitionen in unregulierte Plattformen",
            "Ausschließlich in hochspekulative Werte investieren",
            "Investieren ohne jegliche Informationsbasis",
        ],
    },
    {
        label: "Wie kann man finanzielle Risiken effektiv minimieren?",
        answers: [
            "Kapital auf verschiedene Anlageklassen verteilen",
            "Das gesamte Kapital in eine einzige Anlage stecken",
            "Auf jede Art von Recherche verzichten",
            "Spontan und ohne Strategie investieren",
        ],
    },
    {
        label: "Was beeinflusst direkt die Entwicklung deiner Geldanlage?",
        answers: [
            "Veränderungen an den Finanzmärkten",
            "Anzahl der Likes auf Social Media",
            "Farbe der Benutzeroberfläche",
            "Name des Produktes",
        ],
    },
    {
        label: "Was beschreibt eine besonders erfolgreiche Investition?",
        answers: [
            "Erzielung einer hohen Rendite",
            "Minimale oder keine Wertsteigerung",
            "Vorzeitiger Ausstieg aus der Investition",
            "Nur die erste Einzahlung tätigen",
        ],
    },
];
        ...
        <div class="container quiz-wrapper">
            <div class="quiz-content">
                <div class="content">
                    ...
                    <h2 class="title">Finanzwissen interaktiv testen</h2>
                    <h3 class="sub-title">Wie sicher bist du im Umgang mit Geld?</h3>
                    <h5 class="text">Beantworte gezielte Fragen zu Geldanlage, Sparverhalten, Risikobewertung und Finanzplanung – und finde heraus, wie gut du vorbereitet bist.</h5>
                    ...
                    <button class="btn btn-primary w-100 py-3 first-button" data-action="startQuiz">Jetzt Quiz starten</button>
                </div>
            </div>
        </div>
      `;
...
const finalStep = {
    ...
    <div class="row quiz-content form-content">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 form-block">
            <form id="quiz-form">
                <h2 class="title" style="color: #fff;">Fast geschafft!</h2>
                <p class="text" style="color: #fff; margin-bottom: 20px;">
                    Trage deine Daten ein und erhalte dein persönliches Finanz-Ergebnis.
                </p>

                <input class="form-control" name="name" type="text" placeholder="Max Mustermann" required>
                ...
                <div class="checkbox" style="color: #fff;">
                    ...
                    <label for="privacyPolicy">
                        ...
                        die
                        <a class="form-link" href="privacy-policy.html" target="_blank" style="color: #fff; text-decoration: underline;">Datenschutzrichtlinie</a> sowie die
                ...
                <div class="checkbox" style="color: #fff;">
                    ...
                    <label for="newsletter">Ich möchte Finanztipps per E-Mail erhalten.</label>
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 py-3 first-button">Ergebnis anzeigen</button>
            </form>
        </div>
    </div>
</div>
